...
const lambdas: LambdaEntry[] = [
  ...
  { context: 'identity', handler: 'list-warranty-claims', entry: 'apps/api/src/lambda/identity/list-warranty-claims.handler.ts' },
  { context: 'identity', handler: 'create-warranty-claim', entry: 'apps/api/src/lambda/identity/create-warranty-claim.handler.ts' },
  { context: 'identity', handler: 'update-warranty-claim', entry: 'apps/api/src/lambda/identity/update-warranty-claim.handler.ts' },
  { context: 'identity', handler: 'list-employees', entry: 'apps/api/src/lambda/identity/list-employees.handler.ts' },
  ...
  { context: 'work-orders', handler: 'transition-build-configuration', entry: 'apps/api/src/lambda/work-orders/transition-build-configuration.handler.ts' },
  { context: 'work-orders', handler: 'list-boms', entry: 'apps/api/src/lambda/work-orders/list-boms.handler.ts' },
  { context: 'work-orders', handler: 'create-bom', entry: 'apps/api/src/lambda/work-orders/create-bom.handler.ts' },
  { context: 'work-orders', handler: 'approve-bom', entry: 'apps/api/src/lambda/work-orders/approve-bom.handler.ts' },
  { context: 'work-orders', handler: 'list-routing-templates', entry: 'apps/api/src/lambda/work-orders/list-routing-templates.handler.ts' },
  { context: 'work-orders', handler: 'create-routing-template', entry: 'apps/api/src/lambda/work-orders/create-routing-template.handler.ts' },
  { context: 'work-orders', handler: 'transition-routing-template', entry: 'apps/api/src/lambda/work-orders/transition-routing-template.handler.ts' },
  ...
  { context: 'inventory', handler: 'update-part',               entry: 'apps/api/src/lambda/inventory/update-part.handler.ts' },
  ...
  { context: 'inventory', handler: 'list-locations',            entry: 'apps/api/src/lambda/inventory/list-locations.handler.ts' },
  ...
  { context: 'inventory', handler: 'release-reservation',       entry: 'apps/api/src/lambda/inventory/release-reservation.handler.ts' },
  { context: 'inventory', handler: 'consume-reservation',       entry: 'apps/api/src/lambda/inventory/consume-reservation.handler.ts' },
  { context: 'inventory', handler: 'list-ledger',               entry: 'apps/api/src/lambda/inventory/list-ledger.handler.ts' },
  { context: 'inventory', handler: 'create-adjustment',         entry: 'apps/api/src/lambda/inventory/create-adjustment.handler.ts' },
  { context: 'inventory', handler: 'create-transfer',           entry: 'apps/api/src/lambda/inventory/create-transfer.handler.ts' },
  { context: 'inventory', handler: 'create-cycle-count',        entry: 'apps/api/src/lambda/inventory/create-cycle-count.handler.ts' },
  { context: 'inventory', handler: 'list-vendors',              entry: 'apps/api/src/lambda/inventory/list-vendors.handler.ts' },
  { context: 'inventory', handler: 'get-vendor',               entry: 'apps/api/src/lambda/inventory/get-vendor.handler.ts' },
  { context: 'inventory', handler: 'list-purchase-orders',      entry: 'apps/api/src/lambda/inventory/list-purchase-orders.handler.ts' },
  { context: 'inventory', handler: 'get-purchase-order',       entry: 'apps/api/src/lambda/inventory/get-purchase-order.handler.ts' },
  { context: 'inventory', handler: 'purchase-order-command',    entry: 'apps/api/src/lambda/inventory/purchase-order-command.handler.ts' },
  ...
  { context: 'tickets', handler: 'get-qc-gates',      entry: 'apps/api/src/lambda/tickets/get-qc-gates.handler.ts' },
  { context: 'tickets', handler: 'batch-submit-qc-gates', entry: 'apps/api/src/lambda/tickets/batch-submit-qc-gates.handler.ts' },
  ...
  { context: 'tickets', handler: 'list-routing-steps', entry: 'apps/api/src/lambda/routing-steps/list.handler.ts' },
  ...
  { context: 'tickets', handler: 'create-wo',           entry: 'apps/api/src/lambda/tickets/create-wo.handler.ts' },
  ...
  { context: 'tickets', handler: 'transition-technician-task', entry: 'apps/api/src/lambda/tickets/transition-technician-task.handler.ts' },
  ...
  { context: 'scheduling', handler: 'schedule-preview',      entry: 'apps/api/src/lambda/scheduling/schedule-preview.handler.ts' },
  { context: 'scheduling', handler: 'publish-schedule',      entry: 'apps/api/src/lambda/scheduling/publish-schedule.handler.ts' },
  { context: 'scheduling', handler: 'list-schedule-assignments', entry: 'apps/api/src/lambda/scheduling/list-schedule-assignments.handler.ts' },
