export const AUDIT_POINTS = {
  ...
  customerSyncStart: 'accounting.customer_sync_start',
  customerSyncSucceeded: 'accounting.customer_sync_succeeded',
  customerSyncFailed: 'accounting.customer_sync_failed',
  customerSyncSkipped: 'accounting.customer_sync_skipped',
