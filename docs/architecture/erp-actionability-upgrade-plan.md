...
| Dashboard and KPI deep links       | In Progress | Work-order, inventory parts/reservations, QuickBooks reference lists, reporting cards, and role-dashboard KPI cards use URL-backed filtered destinations                                                    | Extend the same pattern to training/admin filters and the upcoming named reporting catalog              |
