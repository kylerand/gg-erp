...
| Inventory and purchasing workflows | In Progress | PO receiving, PO/vendor list and detail reads, purchase-order drill-in, focused receiving links, and work-order reservation execution are wired to live inventory APIs                                                                                                           | Add PO create/edit/state actions, reorder suggestions, import/export, and broader row actions           |
