...
| Admin configuration catalog        | In Progress | Access, audit, and integrations pages exist; integration health uses strict live QuickBooks, sync queue, account, and reconciliation sources instead of static cards                                        | Add settings-style domains for roles, templates, API keys, webhooks, accounting config                  |
