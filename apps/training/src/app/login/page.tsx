...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#211F1E] text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(227,113,37,0.2),_transparent_34%)]" />
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col justify-center px-5 py-8">
        <div className="rounded-2xl border border-border/60 bg-white/95 p-6 text-[#211F1E]">
          <Image
          ...
          <p className="mt-2 text-center text-sm text-[#6E625A]">
            On-the-job training, SOPs, and certifications.
          </p>
