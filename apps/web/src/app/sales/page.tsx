  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        {[
          { label: 'Pipeline', description: 'Kanban view of deals', href: '/sales/pipeline', icon: '📊' },
          { label: 'Opportunities', description: 'All sales opportunities', href: '/sales/pipeline', icon: '🎯' },
          { label: 'Quotes', description: 'View & manage quotes', href: '/sales/quotes', icon: '📄' },
          { label: 'New Quote', description: 'Create a new quote', href: '/sales/quotes/new', icon: '➕' },
          { label: 'Forecast', description: 'Revenue projections', href: '/sales/forecast', icon: '📈' },
          { label: 'Activity Log', description: 'Calls, emails & notes', href: '/sales/pipeline', icon: '📝' },
        ].map((item) => (
          <Link
            key={item.label}
            href={item.href}
