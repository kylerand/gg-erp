...
| Receiving and PO progression reads | Inventory | ⚠️ In Progress | Team | Mutation flow tracked in dependency map with partial coverage | List/detail query APIs for vendors and POs are incomplete | Add PO/vendor read endpoints and partial-receive payloads |
