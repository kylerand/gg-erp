  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        description: 'Author and reuse released build configuration and BOM pairs.',
      ...
      },
      {
        ...
        description: 'Lock and release versioned cart build definitions.',
        route: '/planning/build-packages',
        status: 'live',
        objectKey: 'build-configuration',
        keywords: ['build configuration', 'configuration', 'version', 'release'],
      },
      {
        key: 'build-bom',
        label: 'Build BOMs',
        description: 'Create and approve material revisions.',
        route: '/planning/build-packages',
        status: 'live',
        objectKey: 'build-bom',
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        description: 'Review operational entries across payables, payments, and reconciliation.',
        route: '/accounting/ledger',
        status: 'live',
        objectKey: 'accounting-ledger',
