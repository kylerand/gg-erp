...
export const ERP_OBJECTS = [
  ...
  },
  {
    ...
    label: 'Cost Evidence',
    pluralLabel: 'Cost Evidence',
    description: 'Post ledger-backed unit cost evidence without changing stock quantity.',
    module: 'inventory',
    kind: 'document',
    ownerContext: 'inventory',
    ...
    status: 'live',
    primaryStatusField: 'movementType',
    searchFields: ['sku', 'partName', 'lotNumber', 'evidenceReference'],
    listColumns: ['sku', 'lotNumber', 'quantityOnHand', 'unitCost', 'postedAt'],
    keywords: ['cost evidence', 'valuation', 'unit cost', 'missing cost'],
  },
  {
    key: 'inventory-transfer',
    label: 'Stock Transfer',
    pluralLabel: 'Stock Transfers',
    description: 'Move available inventory between shop locations with ledger traceability.',
    module: 'inventory',
    kind: 'document',
    ownerContext: 'inventory',
    route: '/inventory/transfers',
    status: 'live',
    primaryStatusField: 'transferStatus',
    searchFields: ['sku', 'partName', 'lotNumber', 'fromLocation', 'toLocation'],
    listColumns: ['transferNumber', 'sku', 'quantity', 'fromLocation', 'toLocation', 'receivedAt'],
    keywords: ['transfer', 'move stock', 'location move', 'warehouse transfer'],
  },
  {
    key: 'cycle-count',
    label: 'Cycle Count',
    pluralLabel: 'Cycle Counts',
    description: 'Post physical inventory counts and ledger-backed variance corrections.',
    module: 'inventory',
    kind: 'document',
    ownerContext: 'inventory',
    route: '/inventory/cycle-counts',
    status: 'live',
    primaryStatusField: 'cycleCountStatus',
    searchFields: ['cycleCountNumber', 'sku', 'partName', 'lotNumber', 'locationName'],
    listColumns: ['cycleCountNumber', 'locationName', 'lineCount', 'varianceCount', 'completedAt'],
    keywords: ['cycle count', 'stock count', 'physical count', 'variance'],
  },
  {
    key: 'purchase-order',
  ...
  },
  {
    ...
    status: 'live',
    primaryStatusField: 'claimStatus',
    searchFields: ['claimNumber', 'customerName', 'dealerName', 'workOrderNumber'],
    numberSeries: 'WCLM-YYYYMMDD-########',
    listColumns: ['claimNumber', 'customerName', 'dealerName', 'status', 'reimbursement'],
    keywords: ['warranty', 'claim', 'reimbursement', 'dealer'],
    quickActions: [
      {
        key: 'create-warranty-claim',
        label: 'New Warranty Claim',
        description: 'Open the warranty claim intake workflow.',
        module: 'customers',
        objectKey: 'warranty-claim',
        route: '/customer-dealers/warranty?create=claim',
        action: 'create',
        status: 'live',
        keywords: ['new', 'create', 'warranty', 'claim', 'reimbursement'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    pluralLabel: 'Build Configurations',
    description: 'Versioned cart build definitions that can be locked and released for production.',
    module: 'planning',
    kind: 'master',
    ownerContext: 'build-planning',
    route: '/planning/build-packages',
    status: 'live',
    primaryStatusField: 'configurationStatus',
    searchFields: ['configurationCode', 'vehicleDisplayName', 'customerDisplayName'],
    listColumns: ['configurationCode', 'vehicleDisplayName', 'configurationVersion', 'status'],
    keywords: ['build configuration', 'configuration', 'version', 'release'],
  },
  {
    key: 'build-bom',
    label: 'Build BOM',
    pluralLabel: 'Build BOMs',
    description: 'Approved material revisions for released build configurations.',
    module: 'planning',
    kind: 'master',
    ownerContext: 'build-planning',
    route: '/planning/build-packages',
    status: 'live',
    primaryStatusField: 'bomStatus',
    searchFields: ['bomCode', 'configurationCode', 'partSku'],
    listColumns: ['bomCode', 'configurationCode', 'revision', 'status'],
    keywords: ['bom', 'bill of materials', 'materials', 'revision'],
  },
  {
    key: 'routing-template',
    label: 'Routing Template',
    pluralLabel: 'Routing Templates',
    description: 'Versioned route and job-card templates for production execution.',
    module: 'planning',
    kind: 'master',
    ownerContext: 'build-planning',
    route: '/planning/build-packages?view=routing',
    status: 'live',
    primaryStatusField: 'templateStatus',
    searchFields: ['routeCode', 'routeName', 'operationCode', 'jobCardTitle'],
    listColumns: ['routeCode', 'routeVersion', 'stepCount', 'status'],
    keywords: ['routing', 'route', 'job card', 'operation', 'template'],
  },
  {
    key: 'planning-change-event',
    label: 'Engineering Change',
    pluralLabel: 'Engineering Changes',
    description:
      'Append-only ECO history across build configurations, BOM revisions, and routing templates.',
    module: 'planning',
    kind: 'document',
    ownerContext: 'build-planning',
    route: '/planning/engineering-changes',
    status: 'live',
    primaryStatusField: 'newStatus',
    searchFields: ['recordCode', 'changeKind', 'changeSummary', 'approvalNote', 'appliedBy'],
    listColumns: ['recordCode', 'versionLabel', 'changeKind', 'createdAt'],
    keywords: ['eco', 'engineering change', 'approval', 'history', 'revision'],
  },
  {
    key: 'accounting-sync',
    label: 'Sync Monitor',
  ...
  },
  {
    ...
    pluralLabel: 'Accounting Ledger Entries',
    description:
      'Operational ledger entries generated from POs, payments, and reconciliation variance.',
    module: 'accounting',
    kind: 'ledger',
    ownerContext: 'accounting',
    route: '/accounting/ledger',
    status: 'live',
    primaryStatusField: 'status',
    searchFields: ['documentNumber', 'counterparty', 'memo', 'sourceType'],
    listColumns: ['ledgerDate', 'documentNumber', 'accountDebit', 'accountCredit', 'amount'],
    keywords: ['ledger', 'journal', 'gl', 'payables', 'payments', 'reconciliation'],
  },
  {
    key: 'accounting-journal',
    label: 'Accounting Journal',
    pluralLabel: 'Accounting Journals',
    description: 'Immutable posted debit and credit lines created from operational ledger entries.',
    module: 'accounting',
    kind: 'ledger',
    ownerContext: 'accounting',
    route: '/accounting/ledger',
    status: 'live',
    primaryStatusField: 'status',
    searchFields: ['journalNumber', 'sourceDocumentNumber', 'counterparty', 'memo'],
    listColumns: ['ledgerDate', 'journalNumber', 'totalDebit', 'totalCredit', 'status'],
  ...
  },
  {
    ...
    pluralLabel: 'Migration Cutovers',
    description: 'Review ShopMonkey rehearsal batches and cutover readiness gates.',
    module: 'admin',
    kind: 'integration',
    ownerContext: 'migration',
    route: '/admin/migration',
    status: 'live',
    primaryStatusField: 'cutoverStatus',
    searchFields: ['sourceFile', 'wave', 'status'],
    listColumns: ['wave', 'sourceFile', 'status', 'recordCount', 'errorCount'],
