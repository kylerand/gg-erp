...
export const ERP_OBJECTS = [
  ...
  },
  {
    ...
    quickActions: [
      {
        key: 'create-sales-opportunity',
        label: 'New Opportunity',
        description: 'Create a sales opportunity from a lead or customer conversation.',
        module: 'sales',
        objectKey: 'sales-opportunity',
        route: '/sales/opportunities/new',
        action: 'create',
        status: 'live',
        keywords: ['new', 'create', 'opportunity', 'lead', 'deal'],
      },
    ],
  },
  {
    ...
    pluralLabel: 'Sales Opportunities',
    description: 'Customer opportunities from lead through quote and close.',
    module: 'sales',
    kind: 'document',
    ownerContext: 'sales',
    route: '/sales/pipeline',
    detailRoute: '/sales/opportunities/:id',
    status: 'live',
    primaryStatusField: 'stage',
    searchFields: ['opportunityName', 'customerName', 'ownerName'],
    listColumns: ['opportunityName', 'customerName', 'stage', 'expectedCloseDate'],
  ...
  },
  {
    ...
    description:
      'Append-only stock movement history for receipts, reservations, issues, and adjustments.',
    module: 'inventory',
    kind: 'ledger',
    ownerContext: 'inventory',
  ...
  },
  {
    ...
    description: 'Post controlled on-hand corrections against live stock lots.',
    module: 'inventory',
    kind: 'document',
    ownerContext: 'inventory',
    route: '/inventory/adjustments',
    status: 'live',
    primaryStatusField: 'adjustmentStatus',
    searchFields: ['sku', 'partName', 'lotNumber', 'reasonCode'],
    listColumns: ['adjustmentNumber', 'sku', 'quantityDelta', 'reasonCode', 'postedAt'],
    keywords: ['adjustment', 'cycle count', 'correction', 'stock count'],
  },
  {
    key: 'purchase-order',
    label: 'Purchase Order',
    pluralLabel: 'Purchase Orders',
    description: 'Track vendor orders, ETAs, receipt progress, and open quantities.',
    module: 'inventory',
    kind: 'document',
    ownerContext: 'procurement',
    route: '/inventory/purchase-orders',
    detailRoute: '/inventory/purchase-orders/:id',
    status: 'live',
    primaryStatusField: 'purchaseOrderState',
    searchFields: ['poNumber', 'vendorName', 'sku'],
    numberSeries: 'PO',
    listColumns: ['poNumber', 'vendorName', 'expectedAt', 'openQuantity', 'status'],
    keywords: ['po', 'purchase', 'vendor', 'eta', 'receiving'],
  },
  {
    key: 'receiving',
    label: 'Receiving',
    ...
    quickActions: [
      {
        key: 'create-customer',
        label: 'New Customer',
        description: 'Open the customer creation workflow.',
        module: 'customers',
        objectKey: 'customer',
        route: '/customers',
        action: 'create',
        status: 'live',
        keywords: ['new', 'create', 'customer', 'contact'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    status: 'live',
    searchFields: ['moduleName', 'moduleCode', 'assigneeName'],
    listColumns: ['moduleName', 'status', 'updatedAt'],
  ...
  },
  {
    key: 'build-package',
    label: 'Build Package',
    pluralLabel: 'Build Packages',
    description: 'Released build configuration and approved BOM pairs for new work orders.',
    module: 'planning',
    kind: 'master',
    ownerContext: 'build-planning',
    route: '/planning/build-packages',
    status: 'live',
    primaryStatusField: 'packageStatus',
    searchFields: ['buildConfigurationId', 'bomId', 'lastWorkOrderNumber', 'customerName'],
    listColumns: ['label', 'buildConfigurationId', 'bomId', 'lastUsedAt'],
  ...
  },
  {
    ...
    pluralLabel: 'Vendor Payables',
    description: 'Received purchase orders that need vendor bill review before QuickBooks entry.',
    module: 'accounting',
    kind: 'queue',
    ownerContext: 'accounting',
    route: '/accounting/sync?view=payables',
    status: 'live',
    primaryStatusField: 'payableStatus',
    searchFields: ['poNumber', 'vendorName', 'vendorCode'],
    listColumns: ['poNumber', 'vendorName', 'receivedValue', 'openQuantity', 'rejectedQuantity'],
  ...
  },
  {
    ...
    pluralLabel: 'QuickBooks Customers',
    description: 'Read-only live customer list from QuickBooks.',
    module: 'accounting',
    kind: 'integration',
    ownerContext: 'accounting',
    route: '/accounting/quickbooks/customers',
    status: 'live',
    primaryStatusField: 'active',
    searchFields: ['displayName', 'companyName', 'email'],
    listColumns: ['displayName', 'companyName', 'active'],
    keywords: ['quickbooks', 'qb', 'customer', 'customers'],
  },
  {
    key: 'quickbooks-invoice',
    label: 'QuickBooks Invoice',
    pluralLabel: 'QuickBooks Invoices',
    description: 'Read-only recent invoice and AR activity from QuickBooks.',
    module: 'accounting',
    kind: 'integration',
    ownerContext: 'accounting',
    route: '/accounting/quickbooks/invoices',
    status: 'live',
    primaryStatusField: 'balance',
    searchFields: ['docNumber', 'customerName', 'txnDate'],
    numberSeries: 'QB-INV',
    listColumns: ['docNumber', 'customerName', 'txnDate', 'totalAmount', 'balance'],
    keywords: ['quickbooks', 'qb', 'invoice', 'ar', 'accounts receivable'],
  },
  {
    key: 'quickbooks-chart-of-accounts',
    label: 'QuickBooks Chart of Accounts',
    pluralLabel: 'QuickBooks Chart of Accounts',
    description: 'Read-only live chart of accounts from QuickBooks.',
    module: 'accounting',
    kind: 'integration',
    ownerContext: 'accounting',
    ...
    status: 'live',
    primaryStatusField: 'active',
    searchFields: ['name', 'accountType', 'accountSubType'],
    listColumns: ['name', 'accountType', 'accountSubType', 'active'],
