...
| Receiving and PO progression reads/actions | Inventory | ✅ Done | Team | `apps/api/src/tests/inventory-reads.test.ts`; `apps/web/src/app/inventory/purchase-orders/page.tsx`; `apps/web/src/app/inventory/purchase-orders/[id]/page.tsx`; `apps/web/src/app/inventory/receiving/page.tsx` | None | Add reorder suggestions, variance reporting, and payable/accounting handoff |
