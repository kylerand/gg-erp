...
| Receiving, PO progression, and replenishment actions | Inventory | ✅ Done | Team | `apps/api/src/tests/inventory-reads.test.ts`; `apps/web/src/app/inventory/purchase-orders/page.tsx`; `apps/web/src/app/inventory/purchase-orders/[id]/page.tsx`; `apps/web/src/app/inventory/receiving/page.tsx`; `apps/web/src/app/inventory/planning/page.tsx` | None | Add variance reporting, payable/accounting handoff, and import/export actions |
