...
export const ERP_OBJECTS = [
  ...
  },
  {
    ...
    description: 'Append-only ECO history across build configurations, BOM revisions, and routing templates.',
    module: 'planning',
    kind: 'document',
    ownerContext: 'build-planning',
  ...
  },
  {
    ...
    description: 'Operational ledger entries generated from POs, payments, and reconciliation variance.',
    module: 'accounting',
    kind: 'ledger',
    ownerContext: 'accounting',
