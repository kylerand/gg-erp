...
| Inventory and purchasing workflows | In Progress | PO receiving, PO/vendor list and detail reads, purchase-order drill-in, focused receiving links, PO create/edit/approve/send/cancel/close actions, work-order reservation execution, and live replenishment recommendations with draft PO creation are wired to live inventory APIs | Add receiving variance reporting, import/export, broader row actions, and payable/accounting handoff    |
