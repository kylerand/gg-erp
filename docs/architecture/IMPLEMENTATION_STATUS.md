...
| Receiving, PO progression, replenishment, and variance actions | Inventory | ✅ Done | Team | `apps/api/src/tests/inventory-reads.test.ts`; `apps/web/src/app/inventory/purchase-orders/page.tsx`; `apps/web/src/app/inventory/purchase-orders/[id]/page.tsx`; `apps/web/src/app/inventory/receiving/page.tsx`; `apps/web/src/app/inventory/planning/page.tsx` | None | Add payable/accounting handoff and import/export actions |
